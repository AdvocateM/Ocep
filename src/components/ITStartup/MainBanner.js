						...
						<div className="row h-100 justify-content-center align-items-center">
							<div className="col-lg-5">
								<div className="hero-content">
									...
									<p>Oceans Engineering is a 100% Black-owned company serving the Burgersfort and Steelpoort regions. Our skilled team delivers compliant, safety-focused engineering services—driven by excellence, professionalism, and industry expertise.</p>
